...
\begin{abstract}
We demonstrate the capabilities of the software package \Rpackage{RpsiXML}. This 
...
intactSample <- parsePsimi25Interaction(intactxml, INTACT.PSIMI25)
intactComplexSample <- parsePsimi25Complex(intactComplexxml, INTACT.PSIMI25)
@ 
...
<<intactHyperGraph>>=
intactHG <- psimi25XML2Graph(intactxml, INTACT.PSIMI25, type="complex")
@ 
